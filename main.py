#######################################################################
# Proposta irrecusável para sua namorada by https://github.com/opZywl #
######################################################################
...
window = pyglet.window.Window(width=640, height=640, caption='Minha Pirikita')
...
nobutton = [pyglet.shapes.Rectangle(400, 380, 100, 50, color=(255, 60, 80, 255), batch=no),
            pyglet.shapes.Circle(400, 405, 25, color=(255, 60, 80, 255), batch=no),
            pyglet.shapes.Circle(500, 405, 25, color=(255, 60, 80, 255), batch=no),
            pyglet.text.Label('Não', font_name='Arial', font_size=20, x=425, y=393, batch=no)
            ]
...
def update_nobutton_colors():
    r, g, b, a = change_colors()
    nobutton[0].color = (r, g, b, a)
    nobutton[1].color = (r, g, b, a)
    nobutton[2].color = (r, g, b, a)
...
def on_mouse_press(x, y, button, modifiers):
    if 75 < x < 225 and 365 < y < 445:
        global hidden
        hidden = False
        webbrowser.open('https://www.youtube.com/watch?v=orWnzqBA63w')
